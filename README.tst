...
! Grafana
1.1 Идешь по ip хоста:3000
P.S. Логин и пароль "admin"
1.2 В поисковике Grafana ищешь Data sources, выбираешь prometheus, в поле Connection вставляешь ссылку на развернутый prometheus и жмякаешь Save & test
1.3 Так же в поисковике ищешь Import dashboard, вбиваешь номер доски 1860 и жмякаешь Load

Вуаля, мониторинг сервера srv настроен)
